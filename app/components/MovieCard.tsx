...
import type { Movie } from "~/services/tmdb.server";
...
export default function MovieCard({ movie }: MovieCardProps) {
  ...
  return (
    ...
    >
      <div className="bg-gray-800 rounded-lg overflow-hidden card-shadow hover:ring-2 hover:ring-red-600 transition-all duration-300">
        {/* 포스터 이미지 */}
